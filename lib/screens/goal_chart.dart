...
//   Future<Box<GoalModel>> _openGoalBox() async {
//     return await Hive.openBox<GoalModel>('goals_$currentUserId');
//   }
...
//         elevation: 2,
//       ),
//       body: FutureBuilder<Box<GoalModel>>(
//         future: _openGoalBox(),
...
//             return Center(child: Text('Error opening goals box: ${snapshot.error}'));
//           }

//           final goalBox = snapshot.data!;
...
//                       mainAxisAlignment: MainAxisAlignment.center,
//                       children: [
//                         legendItem(completedColor, "Completed"),
//                         const SizedBox(width: 20),
//                         legendItem(pendingColor, "Pending"),
//                       ],
//                     ),
//                     const SizedBox(height: 30),
//                     Text("Completed: $completed / $total goals",
