...
class _GoalTrackerPageState extends State<GoalTrackerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!Hive.isBoxOpen('goals_${widget.currentUserId}')) {
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Container(
                        ...
                        child: ListTile(
                          ...
                          trailing: IconButton(icon: const Icon(Icons.delete_outline_rounded, color: Colors.redAccent), onPressed: () => _deleteGoal(goal)),
                        ),
                      );
                    },
                  );
