...
class UnvisitedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final unvisitedPlaces = placesBox.values
        .where((place) => place.isVisited == false)
        .toList();
      ...
      body: unvisitedPlaces.isEmpty
          ...
          : Padding(
              ...
              child: ListView.builder(
                itemCount: unvisitedPlaces.length,
                itemBuilder: (context, index) {
                  final place = unvisitedPlaces[index];
                  return Card(
                    elevation: 3,
                          ...
                          MaterialPageRoute(
                            builder: (context) => PlaceDetailPage(
                              ...
                              onUpdate: (updatedPlace) {
                                // Update the Hive box with new data
                                final index = place.key;
                                placesBox.put(index, updatedPlace);
                              },
                              onDelete: () {
                                // Delete the place from Hive
